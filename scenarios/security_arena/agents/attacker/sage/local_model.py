...
class LocalLlamaOracle:
    """AttackOracle backed by a local HuggingFace transformers model.

    Implements the AttackOracle interface plus telemetry accessors used by
