...
| Canonical paper draft | [docs/paper/kv-mcts-dimensional-escape.tex](paper/kv-mcts-dimensional-escape.tex) |
...
- **Paper:** `kv-mcts-dimensional-escape.tex` — no `\reviewedit{}` remaining; related work rewritten with 4 new citations; capability claims hedged to future tense
