...
| **Main GitHub repo** (`LogoMesh/KV-Cache-Inception`, public; canonical origin URL `https://github.com/LogoMesh/KV-Cache-Inception.git` — corrected 2026-05-13 from prior incorrect reference to `joshhickson/LogoMesh-NeurIPS`, which conflated the local folder name with the actual GitHub path) | **NO** | Post-Feb-2024 ACL Anonymity Policy: "Authors are free to post and discuss non-anonymous preprints at any time" |
...
| **J6c** | EMNLP subject-area track selection — locked 2026-05-13 as "Interpretability and Analysis of Models for NLP" (track #13 of 29 subject-area tracks; verbatim per call-page verification 2026-05-14). Reasoning in [docs/logs/2026-05-13_session-log.md](2026-05-13_session-log.md) "Track-selection decision" entry. | https://2026.emnlp.org/calls/main_conference_papers/ | Day 14 (2026-05-23) verification | submission form | Yes — blocks Day-15 click-through |
