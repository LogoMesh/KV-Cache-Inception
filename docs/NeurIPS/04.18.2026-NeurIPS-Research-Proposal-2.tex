...
while reversible MCTS is projected to require approximately $3.04 \cdot M_{\text{KV}} \approx 493$~GB. The implied ${\sim}60\times$ reduction in working-set memory at $(b, d) = (3, 5)$ is therefore a projection from smaller-scale measurements (Appendix~\ref{sec:reproducibility}) rather than a direct 20B observation.
